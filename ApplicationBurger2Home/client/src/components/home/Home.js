...
const Home = () => {
  ...
  return (
    <main>
      ...
      <Banniere />
      <Area2 titre={t('accueil.area2.titre')} img1={"/picture/formidable.jpeg"} img2={"/picture/it.jpeg"} img3={"/picture/fondant.jpeg"} txt1={t('accueil.area2.txt1')} txt2={t('accueil.area2.txt2')} txt3={t('accueil.area2.txt3')} name="lesStars" />
      <Area1 />
